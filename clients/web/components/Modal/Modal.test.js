...
describe('Modal Component', () => {
  it('should render', () => {
    ...
    expect(component.find('.o-modal').exists()).toBe(true)
    expect(component.find('.o-modal-content').exists()).toBe(true)
    expect(component.find('.o-modal-button').exists()).toBe(true)
  })
  ...
  it('Should confirm when the confirm button is tapped', () => {
    ...
    const mockedEvent = { target: {}, preventDefault: () => {} }
    component.find('.o-modal-button').at(1).simulate('click', mockedEvent)

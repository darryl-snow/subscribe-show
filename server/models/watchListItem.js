...
/**
 * Lookup and save the details for a given item, based on the ID provided from the search results. Called as a pre-save hook for a watchlist item.
 * @param  {WatchListItem}   item The instance of the watchlist item to be saved.
 * @param  {Function} next        The callback function for when all required details have been retrieved.
 */
 ...
 * @param  {WatchListItem}   item The instance of the WatchListItem to which episodes should be appended.
 * @param  {Function} next        Callback function for when all episode data have been retreieved and appended.
 */
 ...
 * @param  {WatchListItem} item         The instance of the WatchListItem to which the episode should be appended.
...
/**
 * Pre-save hook for the watchlist item - called before the item is saved in the DB. During this pre-save hook, we fetch all information about the item.
 * @param  {Function} next The callback function to be called when all relevant information has been retrieved and appended.
 */
